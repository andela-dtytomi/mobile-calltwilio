...
router.post('/call/:id', function(req, res) {
  ...
  // The id will help me customize the response per user. This was set in 
  ...
  if (req.params.id == '1') {
    twiml
      ...
      .play('https://6d236f7f.ngrok.com/magic-chime-01.mp3')
      .say('Yaaayyy!!ß');
  } else {
    twiml 
      .say('Waaaaasssuppppp!!')
      .say('Now you will hear a sound', options)
      .play('https://6d236f7f.ngrok.com/magic-chime-02.mp3')
      .say('Yaaayyy!!', options);
  }
